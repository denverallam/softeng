...
const BoardOfficer = ({ officer }) => {
    ...
    return (
        ...
        <div className="row col-sm-6 mb-4 mx-auto text-center">
            <div className="col-sm-4 mx-auto" style={{ backgroundColor: '#002e5d', backgroundImage: `url(${officer.image})`, backgroundRepeat: 'no-repeat', backgroundSize: '100%', backgroundPosition: 'center center', minHeight: '100px', minWidth: '100px', maxWidth:'100px' }}>
            </div>
